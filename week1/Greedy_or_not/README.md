...
I eventually realized that the code is taking too much time for large arrays mainly because of it's exponential time complexity. I got the idea of implementing dynamic programming in this but was too lazy to do that so left it.
